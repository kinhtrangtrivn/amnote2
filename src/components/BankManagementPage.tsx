...
const getBranchesByProvince = (province: string) => {
  const branchMap: { [key: string]: string[] } = {
    'Hà Nội': ['Chi nhánh Hoàn Kiếm', 'Chi nhánh Ba Đình', 'Chi nhánh Đống Đa', 'Chi nhánh Cầu Giấy', 'Chi nhánh Thanh Xuân'],
    'TP. Hồ Chí Minh': ['Chi nhánh Quận 1', 'Chi nhánh Quận 3', 'Chi nhánh Quận 7', 'Chi nhánh Bình Thạnh', 'Chi nhánh Tân Bình'],
    ...
    'Cần Thơ': ['Chi nhánh Ninh Kiều', 'Chi nhánh Cái Răng', 'Chi nhánh Bình Thủy']
  };
  return branchMap[province] || ['Chi nhánh trung tâm'];
};
...
const mockBanks: Bank[] = [
  {
    ...
    accountName: 'CÔNG TY TNHH ABC TECHNOLOGY',
    currencyType: 'VND'
  },
  {
    id: '2',
...
export default function BankManagementPage() {
  ...
  const getBankNameByCode = (code: string) => {
    const bank = bankCodes.find(b => b.code === code);
    return bank ? bank.name : code;
  };

  const getCurrencyNameByCode = (code: string) => {
    const currency = currencyTypes.find(c => c.code === code);
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div className="sm:flex items-center justify-between mb-6">
          <div className="flex items-center space-x-4 pb-3 md:pb-0">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Quản lý thông tin tài khoản ngân hàng của công ty</p>
            </div>
          </div>
          <button
        ...
        <div className="flex items-center space-x-4 mb-6">
          <div className="flex-1 relative">
            ...
            <input
              type="text"
              placeholder="Tìm kiếm theo tên ngân hàng, mã ngân hàng, số tài khoản..."
              value={searchTerm}
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200">
                ...
                <th className="text-left py-3 px-4 font-medium text-gray-700">Chi nhánh</th>
            ...
            <tbody>
              {filteredBanks.map((bank) => (
                <tr key={bank.id} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="py-3 px-4">
                    <div className="text-gray-900">{bank.branch}</div>
                  </td>
                  <td className="py-3 px-4">
                    <div className="text-gray-900 font-mono">{bank.accountNumber || '-'}</div>
                  </td>
                  <td className="py-3 px-4">
                    <div className="text-gray-900">{bank.currencyType || '-'}</div>
                  </td>
                  <td className="py-3 px-4">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        >
                          ...
                          {formData.province && getBranchesByProvince(formData.province).map(branch => (
