    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="relative">
          ...
          {/* Table */}
          <div className={`overflow-x-auto transition-opacity duration-200 ${isTableLoading ? 'opacity-50' : 'opacity-100'}`}>
            <table className="w-full">
              ...
              <tbody>
                {currentPageData.map((costObject) => (
                  <tr key={costObject.id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-3 px-4">
                      <div className="font-medium text-blue-600">{costObject.code}</div>
                    </td>
                    <td className="py-3 px-4">
                    ...
                    <td className="py-3 px-4">
                      <div className="text-gray-600 max-w-xs truncate" title={costObject.notes}>
                        {costObject.notes || '-'}
                      </div>
                    </td>
                    <td className="py-3 px-4">
            ...
            {filteredCostObjects.length === 0 && !isTableLoading && (
        ...
        {filteredCostObjects.length > 0 && (
          <Pagination
            ...
            totalItems={filteredCostObjects.length}
